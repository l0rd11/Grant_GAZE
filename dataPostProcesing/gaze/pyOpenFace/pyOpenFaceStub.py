import os
import pyopenface
from math import atan2, atan, sqrt, acos, asin, pi


class PyOpenFaceStub():
    def __init__(self):
        base_path = os.path.realpath(__file__)
        base_path = base_path[:base_path.find('pyOpenFace')]
        self.detector = pyopenface.Detector(base_path + "pyOpenFace/model/main_clnf_general.txt")
        self.width = 640.0
        self.height = 480.0
        self.multi = 500.0
    ...
    def getGazeAngle(self, gaze):
        ...
        # y_angle = (acos(gaze_vector[1] / l) - pi / 2)
        y_angle = asin(clean_cos(-gaze_vector[1] / l))
