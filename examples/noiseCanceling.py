...
if __name__ == '__main__':
    ...
    noise_to_add = noise_data[len(src_data):len(src_data) * 2]  # get some noise to add to the signal
    noise_clip = noise_data[:len(src_data)]  # get a different part of the noise clip for calculating statistics
    ...
    output = removeNoise(audio_clip=audio_clip_cafe, noise_clip=noise_clip, n_std_thresh=2, prop_decrease=.95,
                         visual=True)