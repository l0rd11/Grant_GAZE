...
def main(session):
    ...
    try:
        ...
        # tabletService.connectWifi("systemy mobilne")
        # time.sleep(3)
        ...
        # tabletService.playVideo("http://192.168.1.202:8000/SampleVideo_720x480_5mb.mp4")
        # tabletService.playVideo("http://clips.vorwaerts-gmbh.de/big_buck_bunny.mp4")
        # tabletService.preLoadImage("http://192.168.1.202:8000/klep.gif")
        #
        # time.sleep(5)
        tabletService.showImage("http://192.168.1.202:8000/klepsydra.jpg")
